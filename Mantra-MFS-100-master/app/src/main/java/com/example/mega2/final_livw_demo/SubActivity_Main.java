...
public class SubActivity_Main extends AppCompatActivity {
    ...
    public void user(View V) {
        Intent i = new Intent(this, Detail_main.class);
                ...
                public void onClick(View view) {
                    try {
                        ...
                        if (text.toUpperCase().trim().equals("EXPORT DB")) {
                            ...
                            new FileChooser(SubActivity_Main.this).setFileListener(new FileChooser.FileSelectedListener() {
                                @Override
    ...
    private void importDB(File file) {
        ...
        File backupDB = getDatabasePath("AASB.db");
        try {
    ...
    private void exportDB() {
        ...
        File currentDB = getDatabasePath("AASB.db");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            startActivity(new Intent(this, Main_screen_main.class));
        }
        if (id == R.id.navigate) {
            startActivity(new Intent(this, Detail_main.class));
        }
