...
public class Main_screen_main extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    String sess2,dept2,clss2,subj2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNextStu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent i = new Intent(getApplicationContext(), Main_screen_main.class);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (sharedpreferences.contains(Subject)) {
                        subj2 = sharedpreferences.getString(Subject, "");

                    }
                    Toast.makeText(getApplicationContext(),"Getting - sess - "+ sess2 + " dept - "+ dept2 +" class -" +clss2+" subject -"+subj2,Toast.LENGTH_LONG).show();
    ...
    private void launchDismissDlg(String val1,String val2,String val3,String val4,String val5,String val6,String val7,String val8,String val9) {
        ...
        TextView enroll,name,hand,heading,session,dept,class1,subject;
        ImageView img1,pic;
        ...
        subject=(TextView)v.findViewById(R.id.editTextSubject);
        try {
            if(val1.equals("NA"))
            {
                ...
                subject.setText(String.format("Subject : %s", val6));
