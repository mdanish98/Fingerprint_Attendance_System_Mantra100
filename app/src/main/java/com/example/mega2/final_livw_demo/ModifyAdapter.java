...
public class ModifyAdapter extends RecyclerView.Adapter<ModifyAdapter.Holder> implements  Filterable  {
    ...
    public void onBindViewHolder(final Holder holder, int position) {
        ...
        holder.vmode.setText(pojo.getVerifyMode());
        holder.utype.setText(pojo.getUserType());
    ...
    class Holder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView uid, name, vmode, utype,date_of_birth,fcnt;
        CardView card;
        ...
        public Holder(View itemView) {
            ...
            vmode = (TextView) itemView.findViewById(R.id.vmode);
            utype = (TextView) itemView.findViewById(R.id.utype);
